    ...
    <form action="" className="max-w-md mx-auto mt-8 mb-0 space-y-10">
        <div className="space-y-12">
            <div class="relative z-0">
                <input type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[3px] border-gray-400 appearance-none focus:outline-none focus:ring-0 focus:border-red-500 peer text-black" placeholder=" "/>
            ...
            <div class="relative z-0">
                <input type="password" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-[3px] border-gray-400 appearance-none  focus:outline-none focus:ring-0 focus:border-red-500 peer" placeholder=" " />
