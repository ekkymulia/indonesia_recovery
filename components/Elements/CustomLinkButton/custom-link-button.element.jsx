            ...
            <Link href={to}>
                {
                    type === CUSTOM_LINK_BUTTON_TYPES.SPC_INVERTED_ROUNDED ? (
                        <a className="relative inline-block text-sm font-medium text-[#FF0909] active:text-red-500 group focus:outline-none focus:ring" href="/download">
                        ...
                        <a className="relative inline-block text-sm font-medium text-[#FF0909] active:text-red-500 group focus:outline-none focus:ring ml-8" href="/news">
                            <span className="absolute inset-0 border rounded-lg border-current"></span>
