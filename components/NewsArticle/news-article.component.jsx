...
const NewsArticle = () => {
    return (
        <div className="p-8 md:p-12 lg:px-20 lg:py-24 mb-12">
            <div className="my-1 grid grid-flow-col place-content-between">
            ...
            <div className="my-1">
                <h3 className="text-black font-bold text-5xl mt-6 mb-20">How to Improve Indonesia’s Teenagers Computational Skills ?</h3>

                <article className="my-2 text-justify">
