    ...
    return (
        <div className={Class}>
            <div className="md:col-span-3 col-span-5">
                <h3 className="text-xl text-black"><span className="font-bold">Join our pathway</span> to be part of Indonesia's growth journey by keep updated with the latest news!</h3>
            </div>
