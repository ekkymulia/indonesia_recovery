        ...
        <div className={`grid grid-cols-12 ${ClassName}`}>
            <div className="hidden lg:block col-span-12 lg:col-span-4">
                <ul className=" space-y-3">
                    ...
                    {
                        categoryHighlightData.map((item, key) => {
                            return category.slug == item.slug ? (
                                <li key={key+1} className="ml-3 font-semibold flex items-center group cursor-pointer">
            ...
            <div className="col-span-12 lg:col-span-4 my-5 block lg:hidden">
                <ul className=" space-y-3">
                    <li className="ml-3 font-semibold flex items-center group cursor-pointer" onClick={() => setDropdown(!dropdown)}>
                        {
                            dropdown ? (
            ...
            <div className="col-span-12 lg:col-span-8">
                <div className="grid place-content-between lg:grid-flow-col place-items-center">
                    ...
                    <div className="mt-3 lg:mt-0 hidden lg:block">
                        ...
                        className="p-3 text-red-600 border rounded-full transition-colors border-current hover:outline-none hover:bg-red-600 hover:text-white "
                        >
                        <svg
                        ...
                        className="p-3 ml-3 text-red-600 border rounded-full border-current hover:outline-none hover:bg-red-600 hover:text-white "
                        >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="w-5 h-5"
                ...
                <button onClick={() => prevButton()}
                className="p-3 text-red-600 border rounded-full transition-colors border-current active:outline-none active:bg-red-600 active:text-white "
                >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 transform -rotate-180"
                ...
                <button onClick={() => nextButton()}
                className="p-3 ml-3 text-red-600 border rounded-full border-current active:outline-none active:bg-red-600 active:text-white "
                >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5"
